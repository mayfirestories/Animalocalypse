switch(state) {
    case SpawnerState.SPAWNING:
        ...
        if (spawn_timer <= 0) {
            ...
            instance_create_layer(irandom_range(96,room_width-96), y, "Instances", get_random_enemy());
        }

        // Boss time
        if (boss_timer <= 0) {
            var boss = instance_create_layer(irandom_range(96,room_width-96), y, "Instances", obj_boss_enemy);
